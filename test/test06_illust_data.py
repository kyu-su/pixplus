...
class Test_IllustData(TestCase):
  illust_list = [
    {'id': 1580459,
     ...
     'image_url_big':           '://i4.pixiv.net/img-original/img/2008/09/10/17/47/18/1580459_p0.jpg',
     'image_url_medium':        '://i4.pixiv.net/c/600x600/img-master/img/2008/09/10/17/47/18/1580459_p0_master1200.jpg',
    ...
    {'id': 35064276,
     ...
     'manga':                   {'available': False, 'viewed': False},
     'image_url_medium':        '://i1.pixiv.net/c/600x600/img-master/img/2013/04/24/19/31/03/35064276_p0_master1200.jpg',
     'image_url_big':           '://i1.pixiv.net/img-original/img/2013/04/24/19/31/03/35064276_p0.jpg',
    ...
    {'id': 6209105,
     ...
     'image_url_medium':        '://i2.pixiv.net/c/600x600/img-master/img/2009/09/18/15/38/43/6209105_p0_master1200.jpg',
    ...
    {'id': 37442895,
     ...
     'image_url_medium':        '://i4.pixiv.net/c/600x600/img-master/img/2013/07/31/14/33/54/37442895_p0_master1200.jpg',
  ...
  def check_object_equal(self, o1, o2, msg, path = []):
    ...
    if isinstance(o1, dict):
      ...
      if isinstance(o1, str) and o1.startswith('://'):
        o2 = re.sub(r'^https?://', '://', o2)
