...
class Test_IllustData(TestCase):
  illust_list = [
    ...
    {'id': 35064276,
     ...
     'manga':                   {'available': False, 'viewed': False},
     'image_url_base':          'http://i1.pixiv.net/img01/img/pixiv/35064276',
     'image_url_medium':        'http://i1.pixiv.net/img01/img/pixiv/35064276_m.jpg?1366799464',
     'image_url_big':           'http://i1.pixiv.net/img01/img/pixiv/35064276.jpg?1366799464',
     'image_url_suffix':        '.jpg?1366799464',
    ...
    {'id': 6209105,
     'title': '\u30c1\u30e7\u30d3\u30de\u30f3\u30ac',
     'caption': '\u30de\u30f3\u30ac\u3092\u6295\u7a3f\u3059\u308b\u3068\u3053\u306e\u3088\u3046\u306b\u306a\u308a\u307e\u3059\u3002<br /><br />\u30c1\u30e7\u30d3\u30de\u30f3\u30ac\u7d9a\u7de8\uff1a<strong><a href="http://www.pixiv.net/member_illust.php?mode=medium&amp;illust_id=17242686">illust/17242686</a></strong>',
     'tags': [
        '\u304a\u6301\u3061\u5e30\u308a',
        '\u3061\u3087\u3073\u307e\u3093\u30ac',
        '\u306a\u306b\u3053\u308c\u304b\u308f\u3044\u3044',
     ...
     'image_url_base':          'http://i1.pixiv.net/img01/img/pixiv/6209105',
    ...
    {'id': 37442895,
     ...
     'image_url_base':          'http://i1.pixiv.net/img01/img/pixiv/37442895',
  ...
  def test_illust_data(self):
    ...
    for lang_name in lang_names:
      ...
      for data in self.illust_list:
        ...
        self.check_object_equal(data, self.popup_get_illust_data())
        pass
      pass
    pass
